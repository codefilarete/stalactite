 ...
 */
public class ResultSetConverterSupport<I, T> implements ResultSetConverter<I, T>, Converter<ResultSet, List<T>, SQLException> {
	 ...
	 */
	public ResultSetConverterSupport(Class<T> rootType, String columnName, ResultSetReader<I> reader, Function<I, T> beanFactory) {
	 ...
	 */
	public ResultSetConverterSupport(Class<T> rootType, String columnName, ResultSetReader<I> reader, Supplier<T> beanFactory, BiConsumer<T, I> setter) {
	 ...
	 * @param factory
	 */
	private ResultSetConverterSupport(ResultSetRowConverter<I, T> rootConverter, Function<I, T> factory) {
	 ...
	 */
	public <K, V> ResultSetConverterSupport<I, T> add(String columnName, ResultSetReader<K> reader, Class<V> beanType, Function<K, V> beanFactory, BiConsumer<T, V> combiner) {
	 ...
	 * @return this
	 */
	public <K, V> ResultSetConverterSupport<I, T> add(String columnName, ResultSetReader<K> reader, Class<V> beanType, BiConsumer<T, V> combiner) {
	 ...
	 * @return this
	 */
	public <K, V> ResultSetConverterSupport<I, T> add(ResultSetConverterSupport<K, V> relatedBeanCreator, BiConsumer<T, V> combiner) {
	 ...
	 * @return this
	 */
	public <K, V> ResultSetConverterSupport<I, T> add(ResultSetRowConverter<K, V> relatedBeanCreator, BiConsumer<T, V> combiner) {
	 ...
	 * @return this
	 */
	public ResultSetConverterSupport<I, T> add(ResultSetRowAssembler<T> assembler) {
		this.combiners.add(assembler);
		return this;
	}
	
	@Override
	public <C> ResultSetConverterSupport<I, C> copyFor(Class<C> beanType, Function<I, C> beanFactory) {
		// ResultSetRowConverter doesn't have a cache system, so we decorate its factory with a cache checking
		...
		// Making the copy
		ResultSetConverterSupport<I, C> result = new ResultSetConverterSupport<>(rootConverterCopy, beanFactory);
	...
	@Override
	public ResultSetConverterSupport<I, T> copyWithMapping(Function<String, String> columnMapping) {
		...
		ResultSetConverterSupport<I, T> result = new ResultSetConverterSupport<>(rootConverterCopy, this.beanFactory);
		this.combiners.forEach(c -> {
			if (c instanceof Relation) {
	...
	public ResultSetConverterSupport<I, T> copyWithMapping(Map<String, String> columnMapping) {
