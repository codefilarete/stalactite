...
public class JoinedStrategiesSelect<C, I, T extends Table> {
	...
	private void addColumnsToSelect(String tableAlias, Iterable<Column<Table, Object>> selectableColumns, Query query) {
	...
	static class StrategyJoins<I> {
		...
		private final ClassMappingStrategy<I, Object, Table> strategy;
		/** Joins */
		private final List<Join> joins = new ArrayList<>();
		
		private String tableAlias;
		
		StrategyJoins(ClassMappingStrategy<I, ?, Table> strategy) {
			this(strategy, strategy.getTargetTable().getAbsoluteName());
		}
		
		StrategyJoins(ClassMappingStrategy<I, ?, Table> strategy, String absoluteName) {
			this.strategy = (ClassMappingStrategy<I, Object, Table>) strategy;
			this.tableAlias = absoluteName;
		}
		
		public ClassMappingStrategy<I, Object, Table> getStrategy() {
			return strategy;
		}
