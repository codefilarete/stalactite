...
public class SingleTablePolymorphicRelationJoinNode<C, T1 extends Table<T1>, T2 extends Table<T2>, JOINCOLTYPE, I, DTYPE> extends RelationJoinNode<C, T1, T2, JOINCOLTYPE, I> {
	...
	private final Set<ConfiguredEntityReader<? extends C, I, ?>> subPersisters;
	
	private final SingleTablePolymorphism<C, I, DTYPE, T2> polymorphismPolicy;
	...
	public SingleTablePolymorphicRelationJoinNode(JoinNode<?, T1> parent,
												  ...
												  SingleTablePolymorphism<C, I, DTYPE, T2> polymorphismPolicy) {
	...
	public class SingleTablePolymorphicRelationJoinRowConsumer implements RelationJoinRowConsumer<C, I> {
		...
		private final JoinNode<C, T2> joinNode;
		
		private SingleTablePolymorphicRelationJoinRowConsumer(JoinNode<C, T2> joinNode) {
		...
		private class SubEntityDeterminer<D extends C> {
			...
			public SubEntityDeterminer(ConfiguredEntityReader<D, I, ?> subPersister) {
