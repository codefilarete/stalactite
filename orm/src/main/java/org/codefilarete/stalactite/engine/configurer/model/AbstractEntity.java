...
public abstract class AbstractEntity<C, I, T extends Table<T>> {
	...
	public AbstractEntity(IdentifierMapping<C, I> identifierMapping, Mapping<C, T> mapping) {
	...
	public abstract boolean isTablePerClass();
