...
public interface FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S extends Collection<O>> extends FluentSubEntityMappingBuilder<C, I>, OneToManyOptions<C, I, O, S> {
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> mappedBy(Column<?, I> reverseLink);
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> initializeWith(Supplier<S> collectionFactory);
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> cascading(RelationMode relationMode);
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> fetchSeparately();
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> indexedBy(Column<?, Integer> orderingColumn);
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> indexedBy(String columnName);
	 ...
	 */
	@Override
	FluentSubEntityMappingBuilderOneToManyOptions<C, I, O, S> indexed();
