...
//	private PersistenceContext persistenceContext;
	...
	void crud() throws SQLException {
		...
		FluentEntityMappingBuilder<AbstractVehicle, Identifier<Long>> personBuilder = entityBuilder(AbstractVehicle.class, Identifier.LONG_TYPE)
				...
				.mapPolymorphism(PolymorphismPolicy.<AbstractVehicle>tablePerClass()
						.addSubClass(FluentMappings.subentityBuilder(Car.class)
								.map(Car::getId)
								.map(Car::getModel))
						.addSubClass(FluentMappings.subentityBuilder(Truck.class)
								.map(Truck::getId)
								.map(Truck::getColor)));
