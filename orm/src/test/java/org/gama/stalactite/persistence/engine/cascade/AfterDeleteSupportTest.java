...
class AfterDeleteSupportTest {
	...
	void constructorArgsAreInvoked() {
		...
		AfterDeleteSupport testInstance = new AfterDeleteSupport(actionMock, targetProviderMock, targetFilterMock);
		testInstance.afterDelete(Arrays.asList("a", "b", "c"));
	...
	void constructorWithDefaultFilter_acceptAll() {
		...
		AfterDeleteSupport testInstance = new AfterDeleteSupport(actionMock, targetProviderMock);
		testInstance.afterDelete(Arrays.asList("a", "b", "c"));
