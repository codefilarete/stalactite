...
import org.codefilarete.stalactite.spring.repository.query.nativ.SingleTableNativeQueriesTest.StalactiteRepositoryContextConfiguration;
...
@EnableStalactiteRepositories(basePackages = "org.codefilarete.stalactite.spring.repository.query",
		...
		includeFilters = @Filter(
				...
				classes = SingleTableNativeQueriesRepository.class)
)
class SingleTableNativeQueriesTest {
	
	@Autowired
	private SingleTableNativeQueriesRepository derivedQueriesRepository;
