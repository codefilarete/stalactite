...
import org.codefilarete.stalactite.spring.repository.query.nativ.TablePerClassNativeQueriesTest.StalactiteRepositoryContextConfiguration;
...
@EnableStalactiteRepositories(basePackages = "org.codefilarete.stalactite.spring.repository.query",
		...
		includeFilters = @Filter(
				...
				classes = TablePerClassNativeQueriesRepository.class)
)
class TablePerClassNativeQueriesTest {
	
	@Autowired
	private TablePerClassNativeQueriesRepository derivedQueriesRepository;
