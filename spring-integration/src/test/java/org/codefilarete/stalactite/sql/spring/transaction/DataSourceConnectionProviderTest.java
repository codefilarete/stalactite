...
import org.codefilarete.stalactite.sql.spring.transaction.DataSourceConnectionProvider;
...
class DataSourceConnectionProviderTest {
	...
	void giveConnection_givenDataSourceTransactionManager_itsDataSourceIsCalled() throws SQLException {
		...
		DataSourceConnectionProvider testInstance = new DataSourceConnectionProvider(new DataSourceTransactionManager() {
			@Override
