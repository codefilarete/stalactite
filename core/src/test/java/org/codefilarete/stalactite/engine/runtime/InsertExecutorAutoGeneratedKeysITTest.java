...
abstract class InsertExecutorAutoGeneratedKeysITTest extends DatabaseIntegrationTest {
	...
	protected ClassMapping<Toto, Integer, Table> buildAutoGeneratedKeysPersistenceConfiguration() {
		Table targetTable = new Table("Toto");
		PersistentFieldHarverster persistentFieldHarverster = new PersistentFieldHarverster();
		Map<PropertyAccessor<Toto, Object>, Column<Table, Object>> mappedFields = persistentFieldHarverster.mapFields(Toto.class, targetTable);
	...
	void insert_generated_pk_real_life() {
		ClassMapping<Toto, Integer, Table> persistenceConfiguration = buildAutoGeneratedKeysPersistenceConfiguration();
