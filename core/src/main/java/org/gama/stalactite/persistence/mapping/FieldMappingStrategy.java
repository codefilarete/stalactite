 ...
 */
public class FieldMappingStrategy<T> implements IEmbeddedBeanMapper<T> {
	 ...
	 */
	public FieldMappingStrategy(Class<T> targetClass, Table targetTable, Map<Field, Column> fieldToColumn) {
