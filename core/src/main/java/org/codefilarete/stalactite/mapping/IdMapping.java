...
public interface IdMapping<C, I> {
	 ...
	 * 
	 * <br/><br/>
	 * Determining if an instance is persisted or not can merely be done by testing its id against nullity in most cases, that's why this
	...
	/**
	 * Shortcut to {@code getIdentifierType().getIdentifierType()}.
	 *
	 * @return the identifier type
	 */
	default Class<I> getIdentifierType() {
		return getIdentifierInsertionManager().getIdentifierType();
	}
}
