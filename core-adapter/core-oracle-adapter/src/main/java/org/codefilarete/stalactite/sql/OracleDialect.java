...
public class OracleDialect extends DefaultDialect {
	...
	private final OracleSequenceSelectorFactory oracleSequenceSelectorFactory = new OracleSequenceSelectorFactory();
	...
	public DatabaseSequenceSelectorFactory getDatabaseSequenceSelectorFactory() {
		return oracleSequenceSelectorFactory;
	}
	...
	private class OracleSequenceSelectorFactory implements DatabaseSequenceSelectorFactory {
		
		@Override
		public DatabaseSequenceSelector create(Sequence databaseSequence, ConnectionProvider connectionProvider) {
			return new DatabaseSequenceSelector(databaseSequence, "select " + databaseSequence.getAbsoluteName() + ".nextval from dual", getReadOperationFactory(), connectionProvider);
		}
	}
}
