...
public class MySQLDialect extends Dialect {
	...
	public static class MySQLGeneratedKeysReader extends GeneratedKeysReader<Integer> {

		/**
		 * Constructor
		 */
		public MySQLGeneratedKeysReader() {
			// For MySQL generated key column is always named "GENERATED_KEY", could also be retrieve through column number 1
